...
let preloader = () => {
  ...
  wind.on("load", function() {
    ...
    gsap.fromTo(preloader_progress, .5, {
      width: "95%"
    }, {
      width: "100%",
      onUpdate: function() {
      ...
      onComplete: function() {
        ...
        gsap.to(progress_title, 1, {
          autoAlpha: 0,
          y: -100
        });
        gsap.to(progress_loading, 1, {
          autoAlpha: 0,
          y: 100
        });
        gsap.to(progress_number, 1, {
          autoAlpha: 0
        });

        gsap.to(preloader_before, 1, {
          y: "-100%",
          delay: .7
        });
        gsap.to(preloader_after, 1, {
          y: "100%",
          delay: .7,
          onComplete: function() {
