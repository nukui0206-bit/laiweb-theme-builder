...
$enabled_latest_post_modules = array();

foreach ($latest_post_modules as $module_key => $module) {
  if (function_exists('lai_template_can_show_content_module') && lai_template_can_show_content_module($module_key)) {
    $enabled_latest_post_modules[$module_key] = $module;
  }
}
