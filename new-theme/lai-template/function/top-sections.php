...
if (!function_exists('lai_template_is_top_section_enabled')) {
  function lai_template_is_top_section_enabled($section_key)
  {
    return in_array($section_key, lai_template_enabled_top_sections(), true);
  }
}
